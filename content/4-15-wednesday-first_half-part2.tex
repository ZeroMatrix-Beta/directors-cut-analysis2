...
\begin{nicebox}[Cartesian Slicing vs. 3D Box Splitting]
...
\begin{mathstroke}[Cartesian Slicing and Box Definition]
...
\begin{mathstroke}[Direct Cartesian Slicing]
...
\begin{didacticinsight}[The Hidden Cost of Cartesian Integration]
...
\begin{mathstroke}[First Dimensional Split ($k=1$)]
...
\begin{mathstroke}[Expanding the Marginal $\Phi_1$]
\[
...
\begin{mathstroke}[Second Dimensional Split (Applying Fubini to the 2D slice)]
\[
