...
\begin{nice-box}[Board State \& Physical Actions: Cartesian Slicing \& 3D Proof Setup]
The professor erases the polar coordinate calculations and moves to a fresh blackboard. He draws a sphere to address a student's question about alternative integration methods, and then formally defines the 3D box for the Fubini proof.

\textbf{Left Board: Cartesian Slicing of the Sphere}
A 2D cross-section of a sphere is drawn, with a horizontal slice at height $x_3$. 
...
\begin{meta_note}[Student Question]
...
The professor acknowledges the student's geometric intuition but highlights a vital pragmatic truth: Cartesian slicing often leads to integrating roots and complex polynomials. Polar coordinates, while requiring the initial setup of a Jacobian determinant, radically simplify the actual calculus, reducing the integrands to basic trigonometric functions and constants.
