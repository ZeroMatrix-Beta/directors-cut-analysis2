...
\begin{metanote}[Segment Continuation]
...
\begin{ainote}[Establishing Jordan Bounds]
...
\begin{mathstroke}[Inner and Outer Dyadic Sets and Slices]
...
\begin{didacticinsight}[The Geometric Leap]
...
\begin{mathstroke}[Step Function Property]
...
\begin{ainote}[Integrating the Step Functions]
...
\begin{mathstroke}[Combinatorial Integration]
...
\begin{didacticinsight}[Calculus Becomes Counting]
...
\begin{ainote}[Establishing the Squeeze]
...
\begin{mathstroke}[Squeezing the Marginals]
...
\begin{nicebox}[Substituting and Concluding]
...
\begin{mathstroke}[The Final Inequality Chain]
