...
\subsection{Sequences, limits, and completeness}
...
\begin{definition}[Sequences in a set]\label{def:sequence}
...
\begin{definition}[Convergent sequence]\label{def:convergence-limit}
...
\begin{definition}[Accumulation points]\label{def:accumulation-point}
...
\begin{theorem}[Completeness of \texorpdfstring{$\mathbb{R}^n$}{Rn}]\label{thm:rn-complete}
...
\begin{lemma}[Convergence: in \texorpdfstring{$\mathbb{R}^n$}{Rn} versus coordinate-wise]\label{lem:coordinate-convergence}
