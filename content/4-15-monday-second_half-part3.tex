...
\begin{spoken_clean}[30:42 - 34:15]
...
\begin{ainote}[Board State 10: Recalling the Hypograph Connection]
...
\begin{math_stroke}[Integral as a Measure of the Hypograph]
...
\begin{didactic_insight}[The Geometric Unification]
This is the grand unification of the lecture. By framing the integral not as an abstract analytic operation, but as a literal physical volume (the hypograph), the professor allows the students to seamlessly apply the "potato slicing" intuition they just mastered with Cavalieri's Principle directly to abstract function integration.
...
\begin{spoken_clean}[34:15 - 38:00]
...
\begin{ainote}[Board State 11: Formalizing the Sliced Function]
...
\begin{math_stroke}[Function Restriction and Iteration]
...
\begin{orangeformula}[Fubini's Theorem]
...
\begin{spoken_clean}[38:00 - 42:30]
...
\begin{ainote}[Board State 12: The Hypograph Cross-Section]
The professor moves to the right board to draw a masterful 3D perspective of a curved surface floating above a rectangular domain in the $xy$-plane. He uses red chalk to shade a specific 2D planar cross-section beneath the surface, labeling its area as the exact result of the inner integral, $\int f(x_0, y) dy$.
\end{ainote}

\begin{math_stroke}[Geometric Visualization of Fubini's Theorem]
\begin{center}
