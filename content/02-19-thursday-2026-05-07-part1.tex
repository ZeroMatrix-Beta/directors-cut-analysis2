...
\begin{nice-box}[Lemma: Unions and Intersections of Open Sets]
...
\begin{math-stroke}[Proof Sketch: Finite Intersections of Open Sets]
...
\[ \forall i, \exists r_i > 0 \text{ s.t. } B(x, r_i) \subseteq U_i \]
