...
\begin{tikzpicture}[scale=1.0]
    % Axes
    \draw[->, thick, ForestGreen] (-0.5,0) -- (4,0) node[right] {$x \in \mathbb{R}^k$};
    \draw[->, thick, MidnightBlue] (0,-0.5) -- (0,3) node[above] {$y \in \mathbb{R}^{n-k}$};
...
\begin{tikzpicture}[scale=1.8]
    ...
    % Axes
    \draw[->, thick, ForestGreen] (-0.2,0) -- (4,0) node[right] {$x \in \mathbb{R}^k$};
    \draw[->, thick, ForestGreen] (0,-0.2) -- (0,2.5) node[above] {$y \in \mathbb{R}^{n-k}$};
    ...
    \node[BrickRed] at (3.1, 1.6) {$G$};

    % 4. The vertical slice at x
    \draw[thick, MidnightBlue] (1.625, 0) -- (1.625, 2.2);
    \node[below, MidnightBlue] at (1.625, 0) {$x$};
    
    % Highlighting the trapped 1D slice bounds on the slice line
    \draw[line width=2.5pt, BrickRed] (1.625, 0.5) -- (1.625, 1.75); % Outer slice G_x
    \draw[line width=2.5pt, gray] (1.625, 0.68) -- (1.625, 1.55); % True slice A_x (approx bound)
    \draw[line width=2.5pt, Goldenrod] (1.625, 0.75) -- (1.625, 1.5); % Inner slice F_x
    
    % Slice Labels
    \node[BrickRed, right] at (1.625, 1.85) {$G_x$};
    \node[Goldenrod!80!black, right] at (1.625, 0.85) {$F_x$};
\end{tikzpicture}
\end{center}
\begin{explanation-of-steps}
...
\begin{tikzpicture}[scale=1.5]
    % Axes
    \draw[->, thick, ForestGreen] (-0.5,0) -- (4,0) node[right] {$x$};
    \draw[->, thick, MidnightBlue] (0,-0.5) -- (0,3) node[above] {$y$};
    ...
    \draw[ForestGreen, thick] (1.0, 0.7) -- (1.0, 1.3) -- (1.5, 1.3) -- (1.5, 0.7) -- cycle;
    \draw[ForestGreen, thick] (1.0, 1.7) -- (1.0, 2.3) -- (1.5, 2.3) -- (1.5, 1.7) -- cycle;
    \draw[ForestGreen, thick] (2.0, 0.7) -- (2.0, 1.3) -- (2.5, 1.3) -- (2.5, 0.7) -- cycle;
    \draw[ForestGreen, thick] (2.0, 1.7) -- (2.0, 2.3) -- (2.5, 2.3) -- (2.5, 1.7) -- cycle;
    ...
    \draw[ForestGreen, thick, smooth] plot coordinates { (0.9,0.9) (0.9,1.3) (1.3,1.3) (1.3,2.1) (1.7,2.1) (1.7,2.5) (2.3,2.5) (2.3,1.7) (2.9,1.7) (2.9,0.9) (2.0,0.9) (2.0,0.5) (1.0,0.5) (1.0,0.9) (0.9,0.9) };
    ...
    \draw[densely dashed, ForestGreen, thin] (1.7, 0.9) -- (1.7, 2.3);
\end{tikzpicture}
\end{center}
\begin{explanation-of-steps}
