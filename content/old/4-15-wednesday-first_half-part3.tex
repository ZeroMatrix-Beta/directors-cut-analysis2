...
\begin{spoken-clean}[00:30:32 - 00:32:44]
...
\begin{didactic-insight}[Bridging Abstraction and Calculation]
Explicitly acknowledging the cognitive load of $n$-dimensional abstraction lowers anxiety. By giving "permission" to focus on the mechanical application of Fubini's theorem first, it ensures one doesn't get stuck on the rigorous $n$-dimensional notation while still building intuition in 3D space.
...
\begin{spoken-clean}[00:32:56 - 00:37:37]
...
\begin{math-stroke}[Formal Statement of the Theorem (37:40 - 41:03)]
The physical analogy is formalized into rigorous mathematics by defining a compact spatial set $K$ and a time interval $[a,b]$.
...
\begin{spoken-clean}[00:37:40 - 00:41:03]
...
\begin{math-stroke}[Setting up the Limit Definition]
...
\begin{spoken-clean}[00:41:03 - 00:44:55]
Let us begin the proof. We want to compute the derivative with respect to $t$ at $t_0$. By definition, this is the limit as $h$ approaches zero of the difference quotient (i.e., $\lim_{h \to 0} \frac{F(t_0 + h) - F(t_0)}{h}$). To make this cleaner, let's introduce a new function $F(t)$ representing the spatial integral of $f(x,t)$ (i.e., $F(t) = \int_K f(x,t) \, dx$). 
