...
\begin{spoken-clean}[00:32:53 - 00:36:10]
...
\begin{math-stroke}[Computing the 3D Volume Integral]
...
\begin{spoken-clean}[00:36:10 - 00:40:07]
...
\begin{spoken-clean}[00:40:07 - 00:42:00]
...
\begin{math-stroke}[Geometric Visualization: Slicing a Volume]
\begin{center}
\begin{tikzpicture}[scale=1.2]
    ...
    % Thin Slice
    \draw[dashed, thick, BrickRed] (3.5, 0.6) -- (3.5, 2.6);
    \draw[dashed, thick, BrickRed] (3.7, 0.7) -- (3.7, 2.4);
    \fill[BrickRed, opacity=0.4] (3.5, 0.6) to[out=90,in=-90] (3.5,2.6) -- (3.7, 2.4) to[out=-90,in=90] (3.7, 0.7) -- cycle;
    
    % Annotations
    \node[BrickRed, above] at (3.6, 2.8) {Area $\approx A_x$};
    \draw[->, BrickRed] (3.6, -0.2) -- (3.6, 0.5);
    \node[BrickRed, below] at (3.6, -0.2) {Position $x$};
    \draw[<->, BrickRed] (3.5, 0.3) -- (3.7, 0.3) node[midway, below] {$dx$};
\end{tikzpicture}
\end{center}
\end{math-stroke}

\begin{spoken-clean}[00:42:00 - 00:46:30]
...
\begin{math-stroke}[Marginal Densities]
...
\begin{color-box}{BurntOrange}[Cavalieri's Principle]
...
\begin{didactic-insight}[The "I Don't Care" Philosophy]
...
\begin{spoken-clean}[00:46:30 - 00:52:00]
...
\begin{math-stroke}[Dyadic Pixel Approximation]
\begin{center}
\begin{tikzpicture}[scale=0.8]
    ...
    % Smooth Set A
    \draw[thick, MidnightBlue, fill=MidnightBlue!10, opacity=0.5] (2,2) to[out=90,in=180] (4,5) to[out=0,in=90] (6,3) to[out=-90,in=0] (5,1) to[out=180,in=-90] (2,2);
    \node[MidnightBlue] at (4,3) {\Large $A$};
    
    % Inner Approximation F (Yellow Pixels)
    \fill[Goldenrod!50, opacity=0.6] (3,2) rectangle (5,3);
    \fill[Goldenrod!50, opacity=0.6] (3,3) rectangle (5,4);
    \draw[BurntOrange, thick] (3,2) rectangle (5,4);
    \node[BurntOrange] at (4, 2.5) {$F$};

    % Outer Approximation G (Red Pixels)
    \draw[BrickRed, very thick] (1,1) -- (6,1) -- (6,4) -- (7,4) -- (7,6) -- (3,6) -- (3,5) -- (2,5) -- (2,3) -- (1,3) -- cycle;
    \node[BrickRed] at (6.5, 4.5) {$G$};
    
    % Highlight a single column (Slice)
    \fill[ForestGreen!20, opacity=0.5] (4, 0) rectangle (5, 6);
    \draw[dashed, ForestGreen!60!black, thick] (4, 0) -- (4, 6);
    \draw[dashed, ForestGreen!60!black, thick] (5, 0) -- (5, 6);
    \node[ForestGreen!50!black] at (4.5, -0.5) {Slice Column $x$};
\end{tikzpicture}
\end{center}
...
\begin{spoken-clean}[End of Lecture Segment]
...
\begin{color-box}{BurntOrange}[Fubini's Theorem (Informal)]
...
\begin{didactic-insight}[The Grand Finale]
