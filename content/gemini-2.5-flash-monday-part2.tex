...
\begin{spoken_clean}[00:00:00 - 00:00:04]
Okay, so.
\end{spoken_clean}

\begin{spoken_clean}[00:00:04 - 00:00:10]
...
\begin{spoken_clean}[00:00:10 - 00:00:19]
...
\begin{spoken_clean}[00:00:19 - 00:00:39]
So, we have our measurable set. Let me do a drawing. So, we have our set $A$, right? That is contained in a box. Here, we will put the $y$-axis, and this is the $x$-axis. This is actually $\mathbb{R}^k$, and on the $y$-axis we have $\mathbb{R}^{n-k}$, right? And the whole space is $\mathbb{R}^n$, the product of the two.
\end{spoken_clean}

\begin{math_stroke}[Geometric Visualization Setup for Cavalieri's Principle]
\begin{center}
...
\begin{spoken_clean}[00:00:39 - 00:01:23]
...
\begin{math_stroke}[Formalizing the Slices of Set A]
...
\begin{spoken_clean}[00:01:47 - 00:02:20]
...
\begin{math_stroke}[Upper and Lower Measures of Slices]
...
\begin{spoken_clean}[00:02:20 - 00:03:20]
...
\begin{proof}
\begin{spoken_clean}[00:03:20 - 00:04:31]
...
\begin{math_stroke}[Approximation with Dyadic Cubes ($2^{-p}$)]
\begin{center}
\begin{tikzpicture}[scale=1.5]
    % Axes
...
\begin{spoken_clean}[00:04:31 - 00:05:20]
...
\begin{math_stroke}[Dyadic Cube Definition and Product Space]
...
\begin{spoken_clean}[00:05:20 - 00:06:01]
...
\begin{spoken_clean}[00:06:01 - 00:06:57]
...
\begin{math_stroke}[Dyadic Cubes and Approximations]
...
\begin{spoken_clean}[00:06:57 - 00:08:14]
...
\begin{math_stroke}[Slicing Dyadic Approximations]
...
\begin{spoken_clean}[00:08:14 - 00:09:50]
...
\begin{math_stroke}[Defining Step Functions from Slice Measures]
...
\begin{spoken_clean}[00:09:50 - 00:10:33]
...
\begin{math_stroke}[Relating Measures to Riemann Integrals]
Since $F_x \subset A_x \subset G_x$, we have the following inequality for the measures of the slices:
\[
\underline{f(x)} \equiv \mu(F_x) \leq \mu_{in}(A_x) \leq \mu_{out}(A_x) \leq \mu(G_x) \equiv \overline{g(x)}
\]
...
\begin{spoken_clean}[00:10:52 - 00:11:42]
...
\begin{spoken_clean}[00:15:39 - 00:15:42]
So, this is how we prove the theorem.
\end{spoken_clean}

\end{proof}

\begin{spoken_clean}[00:15:46 - 00:15:47]
Is there any question about this?
\end{spoken_clean}

\begin{spoken_clean}[00:16:00 - 00:16:21]
...
\begin{spoken_clean}[00:16:58 - 00:17:02]
...
\begin{spoken_clean}[00:17:02 - 00:17:22]
...
\begin{spoken_clean}[00:17:36 - 00:18:53]
...
\begin{spoken_clean}[00:19:14 - 00:19:53]
...
\begin{spoken_clean}[00:19:53 - 00:20:16]
...
\begin{spoken_clean}[00:20:16 - 00:21:01]
