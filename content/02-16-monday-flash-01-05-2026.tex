...
% Processed on: 2026-05-01 13:25:32
% ==========================================
...
\begin{itemize}
    \item \textbf{Lecturer:} Joaquim Serra
    \item \textbf{Coordinator:} Enric Florit-Simón
    \item \textbf{Lectures:} Mon 08:15--10:00 (ETA F 5), Wed 08:15--10:00 (HG F 7 / HG F 5), Thu 16:15--18:00 (ETA F 5).
\end{itemize}
\end{meta-note}
...
\begin{itemize}
    \setcounter{enumi}{0} \item \textbf{Analysis 1:} Calculus of one variable.
    \setcounter{enumi}{1} \item \textbf{Analysis 2:} Calculus in $\ge 2$ variables.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Vector Addition:} For $x, y \in \mathbb{R}^n$:
    \[ x + y = (x_1 + y_1, \dots, x_n + y_n) \]
    \item \textbf{Scalar Multiplication:} For $x \in \mathbb{R}^n$ and $\lambda \in \mathbb{R}$:
...
\begin{math-stroke}[Definition: Metric Space]
...
\begin{enumerate}
    \setcounter{enumi}{0} \item \textbf{Definiteness:} $d(x, y) = 0 \iff x = y$.
    \setcounter{enumi}{1} \item \textbf{Symmetry:} $d(x, y) = d(y, x)$.
    \setcounter{enumi}{2} \item \textbf{Triangle Inequality:} $d(x, z) \le d(x, y) + d(y, z)$.
\end{enumerate}
\end{definition}
...
\begin{enumerate}
    \setcounter{enumi}{0} \item \textbf{Euclidean Metric:} The standard distance in $\mathbb{R}^n$:
    \[ d_2(x, y) = \|x - y\| = \sqrt{\sum_{i=1}^n (x_i - y_i)^2} \]
    \setcounter{enumi}{1} \item \textbf{Manhattan Metric (Taxicab Metric):} Common in grid-based layouts:
...
\begin{itemize}
    \item \textbf{Inherited Euclidean Metric:} The straight-line distance through the interior of the sphere.
    \item \textbf{Geodesic Metric:} The distance measured along the surface of the sphere (great-circle distance).
\end{itemize}
...
\begin{enumerate}
    \setcounter{enumi}{0} \item \textbf{Supremum Metric (\texorpdfstring{$L^\infty$}{L-infinity} Metric):}
    \[ d_\infty(f, g) = \max_{x \in [a, b]} |f(x) - g(x)| \]
    \setcounter{enumi}{1} \item \textbf{\texorpdfstring{$L^2$}{L2} Metric:}
