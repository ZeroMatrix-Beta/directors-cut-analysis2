...
\lecturechapter{Monday}{Feb 16th}{February 16th 2026}{Introduction}
...
\begin{student-interaction}[Rigor in Tests]
...
\section{Basics of Metric Spaces}
\setcounter{subsection}{0}
\subsection{The Euclidean space \texorpdfstring{$\mathbb{R}^n$}{Rn}}
...
\begin{definition}[Euclidean Structure of \texorpdfstring{$\mathbb{R}^n$}{Rn}]
...
\begin{proposition}[Triangle Inequality in \texorpdfstring{$\mathbb{R}^n$}{Rn}] \label{prop:triangle_inequality}
...
\begin{student-interaction}[Student Spotting the Sign Error]
...
\begin{lemma}[Cauchy-Schwarz Inequality in \texorpdfstring{$\mathbb{R}^n$}{Rn}] \label{lem:cauchy_schwarz}
...
\textbf{Inherited Euclidean Metric:} The straight-line distance through the interior of the sphere.

\textbf{Geodesic Metric:} The distance measured along the surface of the sphere (great-circle distance).
