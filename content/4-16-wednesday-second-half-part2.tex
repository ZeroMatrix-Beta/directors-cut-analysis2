...
\begin{ainote}[Problem Setup: Evaluating the Gaussian Integral]
...
\begin{mathstroke}[Exhaustion by Expanding Balls]
...
\begin{mathstroke}[Polar Coordinates and Fubini's Theorem]
...
\begin{mathstroke}[Evaluating the Limit]
\[
...
\begin{mathstroke}[Exhaustion by Squares and Algebraic Factoring]
