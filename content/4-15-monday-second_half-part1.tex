...
\begin{tikzpicture}[scale=1.5]
    % Axes
    \draw[->, thick, ForestGreen] (0,0) -- (4,0) node[right] {$x$};
    \draw[->, thick, ForestGreen] (0,0) -- (0,3) node[above] {$y$};
    ...
    \draw[thick, Goldenrod] (1.7, 1.3) -- (1.7, 1.8) -- (2.3, 1.8) -- (2.3, 1.6) -- (2.6, 1.6) -- (2.6, 1.2) -- (2.0, 1.2) -- (2.0, 1.0) -- (1.8, 1.0) -- (1.8, 1.3) -- cycle;
    \node[Goldenrod, right] at (2.6, 1.4) {$F$ (Inner)};

    % Outer Approximation G (Red / Jagged)
    \draw[thick, BrickRed] (1.2, 1.0) -- (1.2, 2.2) -- (1.6, 2.2) -- (1.6, 2.4) -- (2.8, 2.4) -- (2.8, 2.0) -- (3.3, 2.0) -- (3.3, 1.0) -- (2.3, 1.0) -- (2.3, 0.6) -- (1.5, 0.6) -- (1.5, 1.0) -- cycle;
    \node[BrickRed, right] at (3.3, 2.1) {$G$ (Outer)};
