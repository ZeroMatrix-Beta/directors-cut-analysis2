...
\begin{tikzpicture}
    ...
    \draw[->, BrickRed, thick] (6.5, 0.1) -- (6.5, 0.5) node[above, BrickRed] {unit vector normal to $\partial\Omega$};
    \draw[Goldenrod, thick, rounded corners] (5.8, -0.2) rectangle (7.5, 0.2);
    \draw[Goldenrod, thick, rounded corners] (7.1, -0.05) circle (0.15);
\end{tikzpicture}
\end{center}
\end{math-stroke}
...
\begin{center}
\begin{tikzpicture}
    \draw[thick, Goldenrod] (4.5,-2.5) circle (0.5);
    \draw[thick, Goldenrod] (4.5,-2.5) to[out=135,in=225] (4.5,-1.5);
    \draw[BrickRed, very thick] (4.2,-2.2) -- (4.8,-1.8);
    \draw[BrickRed, very thick] (4.2,-1.8) -- (4.8,-2.2);
\end{tikzpicture}
\end{center}
\end{math-stroke}
...
\begin{tikzpicture}
    ...
    \draw[thick, BrickRed] (1.5,-2.5) -- (2.5,-2.5);
    \node[below] at (1.5,-2.5) {$a$};
    \node[below] at (2.5,-2.5) {$b$};

    \draw[->, thick] (1.5,-2) .. controls (2,-1.5) and (3,-1.5) .. (3.5,-2) node[above] {$\phi$};

    \draw[thick, BurntOrange] (3.5,-2) .. controls (4,-2.5) and (5,-2.5) .. (5.5,-2);
    \node[above] at (5,-2) {$\phi(V)$};
    \draw[thick, MidnightBlue] (3.5,-2) .. controls (4,-1.5) and (5,-1.5) .. (5.5,-2);
