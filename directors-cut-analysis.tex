...
\setlist[enumerate]{
    ...
    partopsep=0pt,
    label=\textbf{(\alph*)},
    ref=(\alph*) % WICHTIG: ref ohne \textbf, damit die Nummer im Text normal bleibt
}
...
\include{content/02-16-monday-flash-01-05-2026}
\include{content/02-18-wednesday-copy-1}

\include{content/thursday-to-merge-part1}
\include{content/thursday-to-merge-part2}

\include{content/02-19-thursday-2026-05-07-part1}
\include{content/02-19-thursday-2026-05-07-part2}
\include{content/02-19-thursday-2026-05-07-part3}

%\include{folder-34-april-27th-2026/response-2-april-27th-2026}
%\include{folder-34-april-27th-2026/response-3-april-27th-2026}
